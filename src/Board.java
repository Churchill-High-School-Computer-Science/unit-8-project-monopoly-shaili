...
static Map<Integer , Property> propertiesMap= new HashMap<>();
    ...
    public Board(){
        ...
        properties[0][9]= new Property(new Color(175,175,255), "Connectiticut Avenue" , 120,"None",0, 8);
        ...
        properties[9][0]= new Property(new Color(255,0,0), "Pacific Avenue" , 300, "None",0, 26);
        propertiesMap.put(31, properties[9][0]);
        properties[8][0]= new Property(new Color(255,0,0), "North Caroline Avenue" , 300, "None",0, 26);
        propertiesMap.put(32, properties[8][0]);
        properties[7][0]= new Property(new Color(0,255,255), "Community Chest" , 0, "None",0, 0);
        propertiesMap.put(33, properties[7][0]);
        properties[6][0]= new Property(new Color(0,153,204), "Pennsylvania Avenue" , 320, "None",0, 28);
        propertiesMap.put(34, properties[6][0]);
        properties[5][0]= new Property(new Color(0,0,0), "Short Line Railroad" , 200, "None",0, 25);
        propertiesMap.put(35, properties[5][0]);
        properties[4][0]= new Property(new Color(255,200,0), "Chance" , 0, "None",0, 0);
        propertiesMap.put(36, properties[4][0]);
        properties[3][0]= new Property(new Color(0,153,204), "Park Place" , 350, "None",0, 35);
        propertiesMap.put(37, properties[3][0]);
        properties[2][0]= new Property(new Color(192,192,192), "Luxury Tax" , 75, "None",0, 0);
        propertiesMap.put(38, properties[2][0]);
        properties[1][0]= new Property(new Color(0,153,204), "Boardwalk" , 400,"None",0, 50);
